...
--That's the colors and interactions done. "Above Ground Sighter Measurement" also has NULLs. But "none noted" doesn't make sense for a numeric description (even though it's store as text)
...
--Saying '0' doesn't make sense, since the dataset already established 'FALSE' as its '0'. I could change the FALSEs to 0, though. The Eastern Grey Squirrel doesn't burrow, so a squirrel's measurement wouldn't be less than 0.
